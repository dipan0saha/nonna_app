  ...
  group('TileVisibilityProvider Tests', () {
    ...
    group('loadPreferences', () {
      test('loads visibility preferences from storage', () async {
        ...
        when(mockLocalStorageService.getString(any as String))
            .thenReturn(null);
        when(mockLocalStorageService.getObject(any as String))
    ...
    group('setTileVisibility', () {
      test('updates tile visibility in state', () async {
        when(mockLocalStorageService.setObject(any as String, any as Map<String, dynamic>))
            .thenAnswer((_) async {});
      ...
      test('persists visibility to storage', () async {
        ...
        verify(mockLocalStorageService.setObject(any as String, any as Map<String, dynamic>)).called(1);
      });
