  ...
  group('RSVPTasksProvider Tests', () {
    ...
    group('fetchRSVPTasks', () {
      ...
      test('loads events from cache when available', () async {
        ...
        when(mockCacheService.get(any as String)).thenAnswer((_) async => [cachedData]);
      ...
      test('force refresh bypasses cache', () async {
        ...
        verify(mockDatabaseService.select(any as String)).called(greaterThanOrEqualTo(1));
      });
    ...
    group('submitRSVP', () {
      test('submits RSVP and updates state', () async {
        ...
        // Setup insert mock
        when(mockDatabaseService.insert(any as String, any as Map<String, dynamic>))
