...
void main() {
  ...
  group('Third Party Integrations Connectivity Tests', () {
    ...
    testWidgets(
        'AppInitializationService successfully connects to all third-party services without errors or warnings',
      ...
      expect(
        ...
        isTrue,
        reason:
            'Critical initialization (Supabase) failed. Error: ${result.criticalError}',
      );
      ...
      expect(
        ...
        isEmpty,
        reason:
            'Optional services failed to initialize. Warnings: ${result.warnings}',
      );
    });

    testWidgets('Supabase client is reachable and configured',
        (WidgetTester tester) async {
      expect(Supabase.instance.client, isNotNull,
          reason: 'Supabase client must not be null');
    ...
    testWidgets('Firebase Core is initialized', (WidgetTester tester) async {
      ...
      expect(Firebase.apps, isNotEmpty,
          reason: 'Firebase default app should be initialized');
    });
